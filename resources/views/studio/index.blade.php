        ...
        <div class="row layout-spacing layout-top-spacing" id="cancel-row">
            <div class="col-lg-12">
                <div class="widget-content searchable-container list">
                    ...
                    <div class="row tillana-regular">
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                            <form class="form-inline my-2 my-lg-0">
                                <div class="">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg>
                                    <input type="text" class="form-control product-search" id="input-search" placeholder="Buscar Escuela...">
                                </div>
                            </form>
                        </div>
                                ...
                                <div class="modal-dialog modal-dialog-centered" role="document">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button class="btn" data-dismiss="modal"> <i class="flaticon-delete-1"></i> Ignorar</button>
                    ...
                    <div class="searchable-items list tillana-medium">
                        <div class="items items-header-section">
                            <div class="item-content">
                                ...
                                <div class="user-location">
                                    <h4 style="margin-left: 0;">Dirección</h4>
                                </div>
                                <div class="user-phone">
                                    <h4 style="margin-left: 3px;">Contacto</h4>
                                </div>
                                <div class="user-phone">
                        ...
                        <div class="items">
                            <div class="item-content">
                                ...
                                <div class="user-email">
                                    ...
                                    <p class="usr-email-addr" data-email="alan@mail.com">{{$studio->nombre}}</p>
                                </div>
                                <div class="user-location">
                                    <p class="info-title">Dirección: </p>
                                    <p class="usr-location" data-location="Boston, USA">Coyhaique, Chile</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Contacto </p>
                                    <p class="usr-ph-no" data-phone="+1 (070) 123-4567">+56 (9) 0123-4567</p>
                                </div>
