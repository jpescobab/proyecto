                        ...
                        <div class="col-xl-4 col-lg-5 col-md-5 col-sm-7 filtered-list-search layout-spacing align-self-center">
                            <form class="form-inline my-2 my-lg-0">
                                <div class="">
                                    ...
                                    <input type="text" class="form-control product-search" id="input-search" placeholder="Buscar estudiante...">
                                </div>
                            </form>
                        </div>
                        ...
                        <div class="items">
                            <div class="item-content">
                                ...
                                <div class="user-location">
                                    ...
                                    <p class="usr-location" data-location="Boston, USA">{{$student->email}}</p>
                                </div>
                                <div class="user-phone">
                                    <p class="info-title">Contacto </p>
                                    <p class="usr-ph-no" data-phone="+1 (070) 123-4567">{{$student->phone}}</p>
                                </div>
