    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="assets/img/imugi-do-removebg-preview.png"> <span class="navbar-brand-name">IMUGI</span></a>
            </div>
            ...
            <nav id="topbar">
                <ul class="navbar-nav theme-brand flex-row  text-center">
                    <li class="nav-item theme-logo">
                        <a href="index.html">
                            <img src="assets/img/imugi-do-removebg-preview.png" class="navbar-logo" alt="logo">                           
                        </a>
                    </li>
                    <li class="nav-item theme-text">
                        <a href="index.html" class="nav-link"> Imugi do</a>
                    </li>
                </ul>
                ...
                <ul class="list-unstyled menu-categories" id="topAccordion">
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="tables"  data-parent="#topAccordion">
                            <li>
                                <a href="table_dt_basic.html"> Alumnos </a>
                            </li>
                            <li class="sub-sub-submenu-list">
                                ...
                                <ul class="collapse list-unstyled sub-submenu" id="datatable" data-parent="#datatable">
                                    <li>
                                        <a href="table_dt_basic.html"> Apoderados </a>
                                    </li>
                                    <li>
                                        <a href="table_dt_basic-dark.html"> Asistencia </a>
                                    </li>
                                    <li>
                                        <a href="table_dt_ordering_sorting.html"> Grados </a>
                                    </li>
                                    <li>
                                        <a href="table_dt_multi-column_ordering.html"> Categorias</a>
                                    </li>
                                    <li>
                                        <a href="table_dt_multiple_tables.html"> Alumnos</a>
                                    </li>
                                    <li>
                                        <a href="table_dt_alternative_pagination.html"> Pagos</a>
                                    </li>
                                    <!-- <li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="forms"  data-parent="#topAccordion">
                            <li>
                                <a href="form_bootstrap_basic.html"> Nuevo Alumno </a>
                            </li>
                            <li>
                                <a href="form_input_group_basic.html"> Nuevo Apoderado </a>
                            </li>                            
                            <!-- <li>
                    ...
                    <li class="menu single-menu active">
                        ...
                        <ul class="collapse submenu list-unstyled" id="page"  data-parent="#topAccordion">
                            ...
                            <li>
                                <a href="pages_contact_us.html"> Contáctanos </a>
                            </li>
                           
                            <li>
                                <a href="pages_faq2.html"> Preguntas Frecuentes</a>
                            </li>
                                                  
                            <li class="active">
                                <a href="user_profile.html"> Mi Perfil </a>
                            </li>
                            <li>
                                <a href="user_account_setting.html"> Configurar Cuenta </a>
                            </li>                            
                        </ul>
                    </li>
                    ...
                    <li class="menu single-menu">
                        ...
                        <ul class="collapse submenu list-unstyled" id="more" data-parent="#topAccordion">
                            <li>
                                <a href="charts_apex.html"> Gráficos </a>
                            </li>
                            <li class="sub-sub-submenu-list">
                                <a href="#datatable" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Inscripciones <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu" id="datatable" data-parent="#datatable">
                                    <li>
                                        <a href="table_dt_basic.html"> Clínicas </a>
                                    </li>
                                    <li>
                                        <a href="table_dt_basic-dark.html"> Campeonatos </a>
                                    </li>
                                    
                                </ul>
                            </li>
                            <li class="sub-sub-submenu-list">
                                <a href="#starter-kit" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle"> Autorizaciones <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-chevron-right"><polyline points="9 18 15 12 9 6"></polyline></svg> </a>
                                <ul class="collapse list-unstyled sub-submenu eq-animated eq-fadeInUp" id="starter-kit" data-parent="#more">
                                    
                                    <li>
                                        <a href="starter_kit_breadcrumb.html"> Autorización Menores</a>
                                    </li>
                                    <li>
                                        <a href="starter_kit_breadcrumb.html"> Autorizacion Adultos </a>
                                    </li>
                                </ul>
                            </li>
                            <li>
                                <a href="D:\jpescobar\Desktop\imugi\assets\pdf\Manual_GUP_tang_soo_do.pdf"> Manual Gup </a>
                            </li>
                        </ul>
                    </li>
                </ul>
                        ...
                        <div class="user-profile layout-spacing">
                            <div class="widget-content widget-content-area">
                                <!-- <div class="d-flex justify-content-between">
                                    <h3 class="">Imugi Do Coyhaique</h3>
                                ...
                                <div class="text-center">
                                    <img src="assets/img/imugi-do.png" alt="avatar">
                                    <p class=""> </p>
                                </div>
                                    ...
                                    <div class="">
                                        <ul class="contacts-block list-unstyled">
                                            <li class="contacts-block__item">
                                                <!-- <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=""><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>  -->
                                                <h6 class="text-center">Director</h6> 
                                                <p>BSN - Victor Sanchez Sanchez</p>
                                            </li>

                                            <li class="contacts-block__item">
                                                     <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class=""><circle cx="12" cy="8" r="7"></circle><polyline points="8.21 13.89 7 23 12 20 17 23 15.79 13.88"></polyline></svg>
                                                     3er Dan
                                            </li>


                                            <!-- <li class="contacts-block__item">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-facebook"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>@imugidocoyhaique
                                            </li> -->
                                            <li class="contacts-block__item">
...
<!-- Historial -->
                                                ...
                                                <p> 
                                                   ...
                                                   <ul>
                                                        <h6>Técnicas de Manos: </h6>
                                                               <li> Defensa baja (Ha Dan Mahk Kee)</li>
                                                               <li> Puño al centro (Choong Dan Kong Kyuck)</li>
                                                               <li> Puño lateral (Tollyo Kong Kyuck)</li>
                                                               <li> Defensa lateral (Choong Dan Yup Mahk Kee)</li>
                                                               <li> Defensa reforzada (Sang Soo Ha Dan Mahk Kee)</li>
                                                               <li> Bloqueo de afuera hacia adentro (Ahneso Pahkuro Mahk Kee)</li>
                                                               <li> Bloqueo de adentro hacia afuera (Pahkeso Ahnero Mahk Kee)</li>
                                                               <li> Bloqueo alto (Sang Dan Mahk Kee)
                                                               <li> Puño alto (Sang Dan Kong Kyuck)</li>
                                                               <div>
                                                               </div>
                                                            </br>   
                                                                 
                                                        <h6>Técnicas de Patadas: </h6>                                  
                                                                <li> Patada de frente (Ahp Cha Ki)</li>
                                                                <li> Patada de lado (Yup Cha Ki)</li>
                                                                <li> Patada semicircular (Tollyo Cha Ki)</li>
                                                                <li> Patada moviéndose de lado</li>
                                                                <li> Patadas básicas de brinco</li>
                                                                <li> Patada de hacha (Naeryo Cha Ki) </li>                                                        
                                                        </ul>
                                                    </br>
                                                        <ul>
                                                            <h6>Formas (Hyungs)</h6>                                                            
                                                                <li>Sae Kye Hyung Il Bu: Primer forma básica.</li>
                                                                <li>Sae Kye Hyung E Bu: Segunda forma básica.</li>
                                                                <li>Sae Kye Hyung Sam Bu: Tercera forma básica.</li>
                                                        </ul> 
                                                    </br>
                                                        <ul>
                                                                <h6>Pelea Defensiva</h6>
                                                                <li>Pelea de un paso: Técnicas básicas de manos y piernas (1 a la 5).</li>
                            
                                                            
                                                                <h6>Técnicas de Agarre:</h6>
                                                                <li>Se deben conocer al menos 5 técnicas de defensa. Técnicas de agarre de la 1 a la 5  </li>                                                     
                                                        </ul>  
                                                    </br> 
        ...
        <div class="footer-wrapper">
                <div class="footer-section f-section-1">
                    <p class="">Derechos Reservados © 2024 <a target="_blank" href="https://designreset.com"></a></p>
                </div>
                <div class="footer-section f-section-2">
                    <p class="">Imugi do Coyhaique<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-heart"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"></path></svg></p>
                </div>
            </div>
        </div>
        <!--  END CONTENT AREA  -->
